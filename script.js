(function() {
    ...
    const searchableContent = [
        ...
        { type: 'article', title: 'HOW THE RIPPER RIPS: AN EXCLUSIVE INTERVIEW', desc: 'Something terrible lurks within the walls of the Baltimore State Hospital for the Criminally Insane. Dr. Abel Gideon might be the Chesapeake Ripper.', url: '#', badge: 'feature' },
        ...
        { type: 'telegram', title: 'Look! The coolest Hannibal Confession', desc: 'There\'s plenty to enjoy here. Unseen files, confessions, and the whispers of Baltimore\'s darkest society.', url: 'https://t.me/hannibalek', badge: 'extra' },
        { type: 'interview', title: 'HOW THE RIPPER RIPS: AN EXCLUSIVE INTERVIEW', desc: 'Something terrible lurks within the walls of the Baltimore State Hospital for the Criminally Insane. Dr. Abel Gideon might be the Chesapeake Ripper.', url: '#', badge: 'interview' },
